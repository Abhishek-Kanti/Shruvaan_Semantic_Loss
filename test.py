...
# provider2 = "groq"  # or "openai", "groq".

# logger = AuditLogger()
# history_logger = CryptoHistoryLogger()

# p = Prompter(provider=provider, api_key=api_key, logger=logger)
# c = Cryptor(logger=logger, history_logger=history_logger)
# d = Decryptor(logger=logger, history_logger=history_logger)
# praeceptor = Praeceptor(provider=provider2, logger=logger, history_logger=history_logger, cryptor=c, decryptor=d)   # instance
